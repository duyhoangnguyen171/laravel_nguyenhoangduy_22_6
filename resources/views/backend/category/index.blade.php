                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <img class="img-fluid" src="{{ asset('img/categorys/'.$row->image) }}" alt="{{ $row->image }}">
                                </td>
                                <td>{{ $row->name }}</td>
                                <td>{{ $row->slug }}</td>
                                <td class="text-center">
                                    ...
                                    <a href="{{route ('admin.category.show',  $args)}}" class="btn btn-sm btn-warning">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{route ('admin.category.edit',  $args)}}" class="btn btn-sm btn-info">
