                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{route ('admin.topic.show', $args)}}" class="btn btn-sm btn-warning">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{route ('admin.topic.edit', $args)}}" class="btn btn-sm btn-info">
