...
<section class="content">
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-bcontacted table-striped">
                <thead>
                    <tr>
                        <th class="text-center" style="width:40px" scope="col">#</th>
                        <th class="text-center" style="width:90px" scope="col">Họ tên</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{route ('admin.contact.show', $args)}}" class="btn btn-sm btn-warning">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{route ('admin.contact.edit', $args)}}" class="btn btn-sm btn-info">
